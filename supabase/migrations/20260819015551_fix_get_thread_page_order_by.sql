/*
# Fix get_thread_page — ORDER BY + LIMIT conflict
The json_agg ORDER BY conflicts with the outer LIMIT/OFFSET.
Fix: use a subquery to limit rows first, then aggregate.
*/
