...
## 2026-09-14 to 2026-09-20 — weekly report
- Dashboard: https://claude.ai/artifact/2qHBpG6xLX6aPQQtQeKHRp
- Requests: 32,295 · Page views: 17,354 · Visitors: 623 · Cache hit: 54.3%
- New signups: 0 · Trivia responses: 11 · Poll responses: 9 · Pre-game predictions: 2 · Live predictor: 2 (16 total picks submitted across those 2 participants, from `drive_predictions`)
- Traffic quality: Total requests more than tripled week over week (10,715 → 32,295, +201%) and page views rose in step (5,248 → 17,354, +231%), but unique visitors barely moved (632 → 623, −1.4%) and every engagement number held flat — a volume jump with no matching jump in people. 80% of the week's requests (25,868 of 32,295) landed on a single day, Sep 15, and France accounted for 82% of all requests (26,531), up from an already-dominant 59% share the week before — two straight weeks of one country driving the majority of traffic to a Tennessee-fan site. Threats blocked jumped from 16 to 829 (+5,081%), 91% of them on just two days (Sep 14 and Sep 18), and 403/405 responses rose more than 8-fold (193 → 1,623). None of this confirms an attack (threats stayed under 3% of total requests), but the pattern — one day, one country, a spike in blocked/rejected requests — is consistent with automated scanning, not organic growth.
- Note: the Aug 31–Sep 6 week remains missing from `cloudflare_analytics_snapshots` (documented above, not re-flagged in detail here). This week's snapshot is compared to the adjacent Sep 7–13 row.
