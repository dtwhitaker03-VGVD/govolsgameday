  ...
  const fetchActiveGame = useCallback(() => {
    return supabase
      ...
      .select(
        ...
        'home_timeouts_remaining, away_timeouts_remaining, home_first_downs, away_first_downs, ' +
        'home_possession_time, away_possession_time, current_quarter, game_clock, possession, ' +
